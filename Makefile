...
# Generated by qmake (2.01a) (Qt 4.8.0) on: Mon Nov 28 16:11:22 2011
# Project:  QWT.pro
# Template: app
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/QWT1.0.0/ && $(COPY_FILE) --parents main.cpp .tmp/QWT1.0.0/ && (cd `dirname .tmp/QWT1.0.0` && $(TAR) QWT1.0.0.tar QWT1.0.0 && $(COMPRESS) QWT1.0.0.tar) && $(MOVE) `dirname .tmp/QWT1.0.0`/QWT1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/QWT1.0.0
